...
public class ItemMinerPickaxe extends ItemPickaxe {
    ...
    public ItemMinerPickaxe(int par1, EnumToolMaterial par2EnumToolMaterial) {
        ...
        this.setUnlocalizedName(IndustrialScience.modules[2].getPrefix()+".MinerPickaxe."+this.toolMaterial.toString());
        LanguageRegistry.addName(this,WordUtils.capitalize(this.toolMaterial.toString().toLowerCase())+" Miner Pickaxe");
    }
    ...
    public boolean onBlockDestroyed(ItemStack par1ItemStack, World par2World,
        ...
        return super.onBlockDestroyed(par1ItemStack, par2World, par3, par4, par5, par6,
