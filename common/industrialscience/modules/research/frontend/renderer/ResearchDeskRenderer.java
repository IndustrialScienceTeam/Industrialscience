...
public class ResearchDeskRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderTileEntityAt(TileEntity tileentity, double d0, double d1,
        ...
        if (tileentity.getWorldObj()!=null) {
            metavalue=tileentity.getWorldObj().getBlockMetadata(tileentity.xCoord, tileentity.yCoord, tileentity.zCoord);
        }
        ...
        try {
            ResearchBlockType.values()[metavalue].getModel().newInstance().renderModel(0.0625F);
