...
COPIER("Research Copier",
        ...
        new Research(
                ...
                null,
                new Researchstep[]{
                        new Researchstep(0,new ResearchObject(new ItemStack(ResearchModule.researchdesk)), "You have looked at your Researchbook and thought, how cool it would be to share and save your knowledge. You want to think more about this idea"),
                        new Researchstep(1,new ResearchObject(new ItemStack(ResearchModule.researchNote)), "Yout hink the best way to copy researches would be just read your written results and write them down again. So simple.")
                        },
                null,
                null)
        );
...
private ResearchBlockTyp(String name, String modelfile,
        Class<? extends TileEntity> tileentity,TextureGenerator texturegen,  Research research) {
