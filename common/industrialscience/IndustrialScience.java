...
/**
 * The main mod-class
 * It is responsible to initialize the modules and give the needed infomation to them.
 * @author finesim97
 * 
 */
@NetworkMod(
...
public class IndustrialScience {
    ...
    /**
     * The mod PreInit method.
     * Calls the registermodules and giveIDs(with the suggested config file by forge) method.
     * @param event The FMLPreInitializationEvent given by forge.
     */
    @PreInit
    ...
    /**
     * Generates the defalut config file with the IDs and also reads from the config file and gives the modules their requested IDs.
     * @param suggestedConfigurationFile The configfile, in which the mod stores it's block and item IDs.
     */
    ...
    /**
     * The init method of this mod.
     * Calls first initmodules and then loadmodules.
     * @param event The FMLInitializationEvent given by forge.
     */
    @Init
    ...
    /**
     * The postinit method of this mod.
     * Calls postinitmodules method.
     * @param event The FMLInitializationEvent given by forge.
     */
    ...
    /**
     * Calls the load method from every module and registers the GUIHandler from every module at the NetworkRegistry. 
     */
